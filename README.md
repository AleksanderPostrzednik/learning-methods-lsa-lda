...
*   Dataset zawiera kolumny `Learning Style` oraz `Performance` oraz opis tekstowy w pierwszej kolumnie. Nazwy kolumn są automatycznie konwertowane do formatu `learning_style` i `performance`.
